...
const Description = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col  gap-5 md:gap-14 md:flex-row items-start justify-center">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4">
            ...
            your text into eye-catching images with just few clicks. Imagine it,
          ...
          <p className="text-gray-600">
            ...
            design and portraits, even concepts that don't yet exist can be
